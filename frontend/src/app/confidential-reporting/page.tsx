...
// Confidential Reporting Landing Page
export default function ConfidentialReportingPage() {
  return (
      ...
      <div className="container mx-auto px-4 py-8 max-w-7xl">
        ...
        <div className="bg-primary text-white rounded-lg p-4 mb-8">
          <div className="flex justify-between items-center">
            ...
            <Link href="/" className="bg-white text-primary px-6 py-2 rounded-lg font-semibold hover:bg-gray-100 transition-colors">
              Open Dashboard
            </Link>
          </div>
        </div>
